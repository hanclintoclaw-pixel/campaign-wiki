...
Known names present before the crew tampered with the list:

- Ernie Pollock
- Ziggy Hill
- Lizzo Wells
- two unnamed goons, one of whom Valgaut killed during the breach

During the escape, Mevin and Curtis added the crew to the whitelist. That may keep the drone from attacking them, but it also means the drone or whoever recovers it may have crew biometric data.

## Session 2026-07-23 Outcome

- Found in the Pixel Sticks 21st-floor hardware/control room.
- Identified by Curtis as far beyond ordinary youth-gang equipment.
- Mevin and Curtis used the local control interface to add the crew to its whitelist.
- Triggered as cover when Lizzo Wells arrived with Chunky Sparkles.
