---
title: Lafayette Tower CAT Entertainment Host
type: matrix-host
...
sources:
  ...
  - GM/table-created Matrix host expansion on 2026-07-11
---

# Lafayette Tower CAT Entertainment Host
...
- **Routine decker task TNs:**
  ...
  - Locate buried talent analytics, licensing, or project-routing records: **10**
...
## Security Sheaf / Escalation Model

Use the sheaf as a pacing tool. This host should feel like a corporate fortress that becomes more intelligent and more personal the longer the decker stays in.

| Tally | Escalation | Effect |
| --- | --- | --- |
| 2 | Credential Probe | Badge, route, and activity-profile verification begins. |
| 5 | Trace Lattice | CAT correlation systems begin linking the decker to physical location, deck signature, and prior intrusions. |
| 8 | Scramble / Rights Collapse | Directories, schedules, and media assets remix; false routes and decoy files multiply. |
...
### 1. Public Entertainment Shell

The outermost layer looks like a polished entertainment-corporate campus translated into Matrix sculpting: glass atriums, marquees, executive lobbies, bright brand installations, public demo reels, corporate contact surfaces, and visitor-facing directories. This layer is still Red-grade because the front desk is not truly public; it is a controlled corporate reception surface.

Deckers can find:

- sanitized division descriptions and public-facing promotional material
- public talent-development language and sanitized project categories
- visitor, vendor, and media contact channels
- obvious but highly monitored routes into deeper systems

### 2. Corporate Administration and Licensing Stack

Behind the public shell are licensing desks, royalty engines, executive scheduling, brand-partner workrooms, contract vaults, procurement records, and internal communications. The sculpting becomes a vertical corporate studio: elevator banks, sealed glass offices, gold-record conference rooms, private listening rooms, and filing vaults.

Deckers can find:

- artist, vendor, and partner contracts
- licensing records and content-control agreements
- executive calendars and internal routing
- acquisition and distribution plans
- legal-risk notes and reputation-management hooks

### 3. Talent Analytics and Behavioral Modeling Layer

This is where Lafayette Tower stops feeling like a media office and starts feeling like machinery for shaping audiences. The sculpting resembles focus-test theaters, mirror rooms, audience heat maps, model stages, and simulated crowd environments. The host watches the decker as a test subject while the decker watches the host.

Deckers can find:

- audience segmentation models
- talent viability and image-manipulation profiles
- behavioral-response testing records
- campaign influence metrics
- links between entertainment packaging and persuasion architecture

### 4. Production and Building-Slave Layer

Production systems, studio controls, rehearsal spaces, elevator permissions, security cameras, doors, badge readers, environmental systems, and private infrastructure are represented as rigging galleries, light boards, elevator shafts, sealed service corridors, and command catwalks.

Deckers can affect:

- studio routing and playback systems
- security camera visibility
- elevator and door permissions
- meeting-room access
- controlled demo environments
- some building-service cues, subject to GM limits
...
- unreleased entertainment prototypes
- market-shaping experiments
- simsense and immersive-media design notes
...
- a black stage door that was not there a moment ago
- a service elevator descending below the host's mapped floor count
- a locked orchestra pit beneath a demo theater
- a freight lift marked with a project name the host refuses to index
- a blank white room behind the mirror of a focus-test chamber
...
Recommended GM handling:

- Do not reveal the UV layer unless the decker earns the seam through deep-host access, exceptional successes, prior legwork, or a specific story key.
- A failed UV discovery roll should reveal nothing except perhaps that the host is deeper than it looks.
- A failed UV breach roll should lock that route for the current crawl, raise Tally, and plausibly trigger serious IC or physical-security correlation.
- Inside the UV layer, ordinary file searches should become scene challenges: the host may require emotional, symbolic, sensory, or narrative interaction rather than menu navigation.
...
- executive scheduling and internal entertainment-division communications
- behavioral analytics, focus-test models, and audience influence metrics
...
- public directories appear as **glass atriums, marquees, demo reels, and visitor kiosks**
- corporate records appear as **gold-record conference rooms, contract vaults, private listening rooms, and executive elevators**
- analytics appear as **focus-test theaters, mirrored observation booths, heat-map audiences, and reaction-score constellations**
...
- [Little Chiba](../../Locations/Little-Chiba.md)
