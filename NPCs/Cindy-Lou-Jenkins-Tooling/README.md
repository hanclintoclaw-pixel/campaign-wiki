...
- [Cindy Lou GM Control Panel](GM-Control-Panel.md) - Discord-native GM button panel for silence/resume, summaries, Cindy action suggestions, saved voice-line generation/playback, interruption, canon markers, and closeout prompts.
