...
- **Discord output:** include a copyable `@CindyLouBot [HAVEN] PAYDATA SALE` report with seller, broker/haven, mode, points, age, adjusted value, sale roll, final payout / nuyen delta, heat/status note, and Cindy ingest note.
