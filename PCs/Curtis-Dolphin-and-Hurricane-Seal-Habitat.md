...
- **Day 25 — 2026-06-29:** **Final acceptance day** resolved at **2 primary successes** and **2 support successes** from roll **3, 6, 3, 6, 1** against Primary TN 6 and Support TN 4. Curtis gets the habitat through its formal acceptance pass, but it is a near-finish instead of a clean handoff: the water loops hold, alarms answer, creature zones are usable, and the maintenance lanes are safe enough to work, but a few acceptance-list items still need hands-on correction before anyone should call it fully online. The final pass adds progress, but the 4+ primary success quality bonus does not trigger. **Day 25 effect:** +2 PP. **Totals after Day 25:** PP 49, CP -4, QE 6. **Final scheduled outcome:** the habitat is mostly functional but misses the 50 PP on-schedule threshold by 1 PP, so the 44-49 PP outcome band adds **1D3 = 2 extra days**; combined with the unrecovered Day 21 provisional overrun, Curtis needs **3 extra finish days total**.
