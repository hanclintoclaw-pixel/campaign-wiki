...
- Current funds note preserved in dossier: **18,005¥** current nuyen balance (**210¥** after retrofit spending, then **+450¥** added on 2026-04-30, **+5,000¥** added and **-5,000¥** spent on Grandpa's morphing license plate on 2026-06-26, **+5,000¥** from a side mission with unretro, **-2,700¥** for a Rating 3 aquatic filtration / marine life-support knowsoft, **+15,000¥** from the Griswell / Alvin / Palermo job on 2026-07-02, and **+45¥** net from completed Curtis Drone Shift Work Orders Tutorial 2-5).
