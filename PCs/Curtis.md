...
- **Known current Karma:** **3 Karma** after 2026-08-06 Discord request.
- **Known current nuyen:** **4,365¥**.

<details markdown="1">
<summary>Show Karma and nuyen history</summary>

- **Current Karma history:** **40 Karma** tracking baseline set on 2026-08-05 by Discord request; **-15 Karma** spent on 2026-08-05 to buy **Mech Bladed Weapons 4**, leaving **25 Karma**; **-12 Karma** spent on 2026-08-05 to raise **Intelligence from 5 to 6**, leaving **13 Karma**; current Karma set to **3 Karma** by Discord request on 2026-08-06. Earlier wiki-tracked awards remain listed below as provenance, but the running count starts from the explicit 40-Karma baseline.
